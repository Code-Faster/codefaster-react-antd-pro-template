...
function page (project, params) {
  ...
  fs.writeFileSync(path.join(params.releasePath, pojo + "/index.tsx"), template);
}
...
function model (project, params) {
  ...
  fs.writeFileSync(path.join(params.releasePath, pojo + "/model.d.ts"), template);
}
  ...
  _createClass(CodeGenerator, [{
    ...
    value: function generatorPage(params) {
      ...
      if ((_params$model = params.model) !== null && _params$model !== void 0 && _params$model.tableName) {
        ...
        // 先生成CURD目录
        var dir = path.join(params.releasePath, tranformHumpStr((_params$model2 = params.model) === null || _params$model2 === void 0 ? void 0 : _params$model2.tableName));
